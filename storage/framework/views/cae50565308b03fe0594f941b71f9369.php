...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.full-page-loading','data' => ['target' => 'kelolaModul,kelolaPelaksanaan','message' => 'Memuat data pertemuan...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['target' => 'kelolaModul,kelolaPelaksanaan','message' => 'Memuat data pertemuan...']); ?>
                    ...
                    <div class="row g-2 mb-3">
                            ...
                            <select id="filter-semester" class="form-select" wire:model.live="semester_id">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $semesterOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($semester->id_semester); ?>">
                                        <?php echo e(ucfirst($semester->nama)); ?> <?php echo e($semester->tahun); ?><?php echo e($semester->is_aktif ? ' (aktif)' : ''); ?>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <button type="button" class="btn btn-outline-secondary" wire:click="resetFilters" title="Reset filter">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $pertemuanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'pertemuan-saya-'.e($item->id_pertemuan_blok).''; ?>wire:key="pertemuan-saya-<?php echo e($item->id_pertemuan_blok); ?>">
                                        <td>
                                            <div class="small text-muted">Rencana</div>
                                            <div class="fw-semibold"><?php echo e($item->tanggal?->format('d/m/Y') ?: 'Belum dijadwalkan'); ?></div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->jam_mulai || $item->jam_selesai): ?>
                                                <div class="small text-muted">
                                                    ...
                                                    <?php echo e($item->ruangan ? ' · '.$item->ruangan : ''); ?>

                                                </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->monitoring_pertemuan_blok?->tanggal_realisasi): ?>
                                                <div class="small text-muted mt-2">Realisasi</div>
                                                <div class="small fw-semibold text-success">
                                                    <?php echo e($item->monitoring_pertemuan_blok->tanggal_realisasi->format('d/m/Y')); ?>

                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->monitoring_pertemuan_blok->jam_mulai_realisasi): ?>
                                                        · <?php echo e($this->formatJam($item->monitoring_pertemuan_blok->jam_mulai_realisasi)); ?>
                                        ...
                                        <td>
                                            <div class="d-flex flex-column align-items-start gap-1">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->materi_rinci_blok?->pertemuan_ke): ?>
                                                    <span class="badge bg-light text-dark border">Pertemuan <?php echo e($item->materi_rinci_blok->pertemuan_ke); ?></span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <div class="small fw-semibold text-wrap">
                                                    <?php echo e($item->materi_rinci_blok?->judul ?: $item->topik); ?>

                                                </div>
                                                <div class="text-muted small"><?php echo e($item->blok?->kode); ?> · <?php echo e($item->blok?->nama); ?></div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge bg-info-subtle text-info"><?php echo e($item->aturan_kegiatan_blok?->jenis_kegiatan?->nama); ?></span>
                                            <div class="small fw-semibold mt-1"><?php echo e($item->kelompok_blok?->kode ?: 'Tanpa kelompok'); ?></div>
                                            ...
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->kelompok_blok?->anggota_kelompok_blok_count): ?>
                                                <div class="text-muted small"><?php echo e($item->kelompok_blok->anggota_kelompok_blok_count); ?> mahasiswa</div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <div class="d-flex justify-content-between gap-3 small mb-1">
                                                ...
                                                <?php elseif(! $item->presensi_tercatat_count): ?>
                                                    <span class="badge bg-warning-subtle text-warning">belum diisi</span>
                                                <?php else: ?>
                                                    <span class="fw-semibold"><?php echo e($item->presensi_hadir_count); ?>/<?php echo e($item->kelompok_blok?->anggota_kelompok_blok_count ?? $item->presensi_tercatat_count); ?> hadir</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                            <div class="d-flex justify-content-between gap-3 small">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php elseif(! $item->nilai_tercatat_count): ?>
                                                        <span class="badge bg-warning-subtle text-warning">belum diisi</span>
                                                    <?php elseif($selTarget > 0 && $item->nilai_tercatat_count < $selTarget): ?>
                                                        <span class="badge bg-warning-subtle text-warning"><?php echo e($item->nilai_tercatat_count); ?>/<?php echo e($selTarget); ?></span>
                                                    <?php else: ?>
                                        ...
                                        <td class="text-end">
                                            <button type="button" class="btn btn-primary btn-sm"
                                                wire:click="kelolaModul('<?php echo e($item->id_pertemuan_blok); ?>')">
                                                <i class="ri-links-line"></i> Modul
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->lampiran_materi_blok_count > 0): ?>
                                                    <span class="badge bg-light text-primary ms-1"
                                                        title="tautan khusus kelompok ini"><?php echo e($item->lampiran_materi_blok_count); ?></span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </button>
                                            <button type="button" class="btn btn-secondary btn-sm mt-1"
                                                wire:click="kelolaPelaksanaan('<?php echo e($item->id_pertemuan_blok); ?>', 'pelaksanaan')">
                                                <i class="ri-booklet-line"></i> <?php echo e($jurnal?->divalidasi_pada ? 'Lihat Monitoring' : 'Isi Monitoring'); ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->aturan_kegiatan_blok?->perlu_logbook): ?>
                                                <button type="button" class="btn btn-warning btn-sm mt-1"
                                                    wire:click="kelolaPelaksanaan('<?php echo e($item->id_pertemuan_blok); ?>', 'logbook')">
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $pertemuan_terpilih || ! $materi_rinci_terpilih): ?>
                        <div class="text-muted">Pilih tombol Kelola pada salah satu pertemuan.</div>
                    <?php else: ?>
                        <div class="border rounded p-3 mb-3 bg-light">
                            <div class="text-muted small">Pertemuan</div>
                            <div class="fw-semibold"><?php echo e($modul_judul); ?></div>
                        </div>
...
[$__name, $__params] = $__split('blok-operasional.lampiran-materi', ['materi_rinci_blok_id' => $materi_rinci_terpilih,'pertemuan_blok_id' => $pertemuan_terpilih]);

$__keyOuter = $__key ?? null;

$__key = 'lampiran-saya-'.$pertemuan_terpilih;
$__componentSlots = [];

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3886792402-0', $__key);
                ...
                <div class="modal-body">
                    ...
                    <?php else: ?>
                        <div class="border rounded p-3 mb-3 bg-light">
                            ...
                            <div class="text-muted small"><?php echo e($pelaksanaan_konteks); ?></div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pelaksanaan_jadwal): ?>
                                <div class="text-muted small mt-1"><i class="ri-calendar-line"></i> <?php echo e($pelaksanaan_jadwal); ?></div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        ...
                        <ul class="nav nav-pills mb-3">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pelaksanaan_perlu_penilaian): ?>
                                <li class="nav-item">
                                    <button type="button"
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pelaksanaan_perlu_logbook): ?>
                                <li class="nav-item">
                                    <button type="button"
                                        class="nav-link <?php echo e($pelaksanaan_mode === 'logbook' ? 'active' : ''); ?>"
...
$__key = 'nilai-saya-'.$pelaksanaan_pertemuan_id;
$__componentSlots = [];

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3886792402-1', $__key);
...
unset($__split);
?>
                        <?php elseif($pelaksanaan_mode === 'logbook'): ?>
                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('logbook-pertemuan', ['pertemuan_blok_id' => $pelaksanaan_pertemuan_id]);

$__keyOuter = $__key ?? null;

$__key = 'logbook-saya-'.$pelaksanaan_pertemuan_id;
$__componentSlots = [];

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3886792402-2', $__key);
...
$__key = 'jurnal-saya-'.$pelaksanaan_pertemuan_id;
$__componentSlots = [];

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3886792402-3', $__key);
...
$__key = 'presensi-saya-'.$pelaksanaan_pertemuan_id;
$__componentSlots = [];

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3886792402-4', $__key);
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\laragon\www\sistem-blok\resources\views\pages\pertemuan-saya\index.blade.php ENDPATH**/ ?>