...
class LogbookPertemuanBlokTest extends TestCase
{
    ...
    public function test_monitoring_belum_disimpan_menolak_unggahan(): void
    {
        Storage::fake('local');
    ...
    private function fixture(bool $aktif = true, bool $monitoringTersimpan = true): array
    {
