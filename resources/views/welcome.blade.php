    ...
    <div class="bar" id="bar">
        <div class="wrap bar__inner">
            ...
            <div class="bar__act">
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}" class="act act--solid">
                            <i class="ri-dashboard-line"></i> Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="act act--line">
                            <i class="ri-login-circle-line"></i> Login
                        </a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="act act--solid">Daftar</a>
                        @endif
                    @endauth
                @endif
            </div>
    ...
    <main id="utama">
            ...
            <div class="wrap hero__grid">
                <div class="hero__body">
                    ...
                    <div class="hero__act rise">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="act act--solid act--lg">
                                <i class="ri-dashboard-2-line"></i> Buka dashboard
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="act act--solid act--lg">
                ...
                <div class="crest">
                    <img src="{{ asset('assets/images/favicon/favicon-uinjambi.svg') }}"
        ...
        <section class="band">
            <div class="wrap band__inner">
                ...
                @auth
                    <a href="{{ url('/dashboard') }}" class="act act--light act--lg">
                        <i class="ri-dashboard-2-line"></i> Buka dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}" class="act act--light act--lg">
                        <i class="ri-login-box-line"></i> Login ke sistem
                    </a>
                @endauth
            </div>
